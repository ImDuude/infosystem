      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          ...
          <div class="modal-body">
            ...
            <input type="text" id="create-baugruppe" v-model="hoehe" placeholder="Höhe in cm">
          </div>

          <div class="modal-footer">
            <slot name="footer">
                <button id="add-button" type="submit" v-on:click="createBaugruppe" @click="$emit('close')">Hinzufügen</button>
